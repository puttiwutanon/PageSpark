...
sample_episode = {
      "episode_number": 4,
      "title": "หาเฟสที่ต่างกันของคลื่นสองขบวน",
      "core_vocabulary": [
        "ความถี่",
        "เฟส",
        "เวลา",
      ...
      "video_plan": {
        ...
        "visual_cues": "แสดงโจทย์, แสดงความถี่และเวลา, คำนวณจำนวนรอบคลื่นของแต่ละขบวน, คำนวณผลต่างจำนวนรอบ, แปลงผลต่างจำนวนรอบเป็นเฟสที่ต่างกัน, แสดงผลลัพธ์",
        "audio_cues": "อธิบายโจทย์, อธิบายการหาจำนวนรอบคลื่น, อธิบายการหาผลต่างของเฟส, สรุปคำตอบ"
      },
      "script": {
        "hook": "ถ้าเรามีคลื่นสองขบวนที่มีความถี่ต่างกัน  และเริ่มจากเฟสเดียวกัน  เมื่อเวลาผ่านไป  เฟสของมันจะต่างกันเท่าไหร่  มาดูกัน!",
        "main_body": "โจทย์ข้อนี้ให้ความถี่ของคลื่นขบวนแรกมา หนึ่งร้อยยี่สิบ เฮิรตซ์  และความถี่ของคลื่นขบวนที่สอง หนึ่งร้อยยี่สิบสอง เฮิรตซ์  ทั้งสองขบวนเริ่มเคลื่อนที่จากจุดเดียวกันด้วยเฟสตรงกัน  เมื่อเวลาผ่านไป หนึ่งจุดสอง วินาที  เราต้องหาว่าคลื่นทั้งสองจะมีเฟสต่างกันเท่าไหร่  เราสามารถหาจำนวนรอบคลื่นที่แต่ละขบวนเคลื่อนที่ได้  โดยเอาความถี่คูณด้วยเวลา  สำหรับคลื่นขบวนแรก  จำนวนรอบ เอ็นหนึ่ง  เท่ากับ หนึ่งร้อยยี่สิบ คูณ หนึ่งจุดสอง  ได้เท่ากับ หนึ่งร้อยสี่สิบสี่ รอบ  สำหรับคลื่นขบวนที่สอง  จำนวนรอบ เอ็นสอง  เท่ากับ หนึ่งร้อยยี่สิบสอง คูณ หนึ่งจุดสอง  ได้เท่ากับ หนึ่งร้อยสี่สิบหกจุดสี่ รอบ",
        "example_or_trick": "จากนั้น  เราก็หาผลต่างของจำนวนรอบคลื่นทั้งสอง  ซึ่งก็คือ เดลต้าเอ็น  เท่ากับ หนึ่งร้อยสี่สิบหกจุดสี่ ลบ หนึ่งร้อยสี่สิบสี่  ได้เท่ากับ สองจุดสี่ รอบ  เนื่องจากหนึ่งรอบคลื่นเท่ากับ สองพาย เรเดียน  ดังนั้น  เฟสที่ต่างกัน เดลต้าฟาย  จะเท่ากับ สองจุดสี่ คูณ สองพาย  ซึ่งก็คือ สี่จุดแปดพาย เรเดียน  นี่คือเฟสที่ต่างกันของคลื่นทั้งสองขบวนเมื่อเวลาผ่านไป หนึ่งจุดสอง วินาที",
        "call_to_action": "การเข้าใจเรื่องความถี่และเฟส  ช่วยให้เราวิเคราะห์ปรากฏการณ์คลื่นได้อย่างแม่นยำนะ!"
      },
      "manim_code_lines": [
        "import numpy as np",
        "from manim import *",
