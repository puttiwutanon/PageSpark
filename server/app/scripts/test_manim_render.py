...
sample_episode = {
      "episode_number": 1,
      "title": "ระเบิดตกไกลแค่ไหน? (ตอนที่ 1)",
      "core_vocabulary": [
        "โพรเจกไทล์",
      ...
      "video_plan": {
        ...
        "visual_cues": "แสดงเครื่องบินบินในแนวระดับและทิ้งระเบิด, ระเบิดเคลื่อนที่แบบโพรเจกไทล์, แสดงแกนพิกัด, แสดงเวกเตอร์ความเร็วต้น, แสดงเส้นทางการเคลื่อนที่, แสดงการคำนวณเวลาและระยะทางแนวราบในส่วนล่างของจอ",
        "audio_cues": "เสียงบรรยายอธิบายการแยกพิจารณาการเคลื่อนที่แนวดิ่งและแนวราบ, อธิบายสูตรและขั้นตอนการคำนวณทีละขั้น"
      },
      "script": {
        "hook": "เคยสงสัยไหมว่าเวลาเครื่องบินทิ้งระเบิด ระเบิดจะตกตรงไหน? มันไม่ได้ตกตรงๆ ใต้เครื่องบินนะ! วันนี้เราจะมาดูกันว่าระเบิดจะตกไกลจากจุดที่ทิ้งไปเท่าไหร่กัน!",
        "main_body": "โจทย์ข้อนี้บอกว่าเครื่องบินบินในแนวระดับด้วยความเร็ว 200 เมตรต่อวินาที ที่ความสูง 2000 เมตร แล้วทิ้งระเบิด เราต้องหาว่าระเบิดจะตกไกลจากจุดที่ทิ้งไปตามแนวราบเท่าไหร่ หลักการของโพรเจกไทล์คือเราจะแยกพิจารณาการเคลื่อนที่ในแนวดิ่งและแนวราบออกจากกัน ในแนวดิ่ง ระเบิดจะเคลื่อนที่ภายใต้แรงโน้มถ่วง โดยมีความเร็วต้นแนวดิ่งเป็นศูนย์ เพราะถูกทิ้งในแนวระดับ ส่วนในแนวราบ ระเบิดจะเคลื่อนที่ด้วยความเร็วคงที่เท่ากับความเร็วของเครื่องบินตอนที่ทิ้งระเบิดออกมานั่นเอง",
        "example_or_trick": "เราจะเริ่มจากการหาเวลาที่ระเบิดใช้ในการตกถึงพื้นก่อน โดยใช้สมการการเคลื่อนที่ในแนวดิ่ง `s_y = u_y t + 1/2 g t^2` เมื่อแทนค่าความสูง 2000 เมตร และความเร่งโน้มถ่วง 10 เมตรต่อวินาทีกำลังสอง เราจะได้เวลา `t = 20` วินาที พอได้เวลาแล้ว เราก็เอาไปคำนวณระยะทางแนวราบได้เลย ด้วยสมการ `s_x = u_x t` ซึ่งจะได้ระยะทางแนวราบ `s_x = 4000` เมตร หรือ 4 กิโลเมตรเลยทีเดียว!",
        "call_to_action": "เห็นไหมว่าการแยกคิดแนวดิ่งกับแนวราบช่วยให้เราแก้โจทย์ได้ง่ายขึ้นเยอะเลย! ในตอนหน้า เราจะมาดูกันว่าระเบิดจะกระทบพื้นด้วยความเร็วเท่าไหร่ อย่าลืมติดตามนะ!"
      },
      "manim_code_lines": [
        "from manim import *",
        "import numpy as np",
