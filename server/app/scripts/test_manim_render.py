...
sample_episode = {
      "episode_number": 2,
      "title": "ระเบิดจากเครื่องบิน: ระยะทางและอัตราเร็วสุดท้าย",
      "core_vocabulary": [
        "ความเร็วต้น",
        "ความเร่งโน้มถ่วง",
        "ระยะทางแนวราบ",
      ...
      "video_plan": {
        ...
        "visual_cues": "แสดงแกนพิกัด, เครื่องบินและระเบิด, เส้นทางการเคลื่อนที่แบบพาราโบลา, ป้ายกำกับความเร็วต้นแนวราบและความสูง, แสดงสมการคำนวณเวลา, ระยะทางแนวราบ, ความเร็วแนวดิ่งสุดท้าย, และอัตราเร็วสุดท้ายรวม, แสดงเวกเตอร์ความเร็วที่จุดตก",
        "audio_cues": "อธิบายโจทย์, ขั้นตอนการคำนวณเวลา, ขั้นตอนการคำนวณระยะทางแนวราบ, ขั้นตอนการคำนวณความเร็วแนวดิ่งสุดท้าย, ขั้นตอนการคำนวณอัตราเร็วสุดท้ายรวม, สรุปคำตอบ"
      },
      "script": {
        "hook": "เคยดูหนังที่เครื่องบินทิ้งระเบิดแล้วสงสัยไหมว่าระเบิดจะตกไปไกลแค่ไหน และจะมีความเร็วเท่าไหร่ตอนกระทบพื้น?  วันนี้เราจะมาคำนวณกัน!",
        "main_body": "โจทย์ข้อนี้บอกว่าเครื่องบินบินในแนวระดับด้วยความเร็ว สองร้อย เมตรต่อวินาที  ที่ความสูง สองพัน เมตร  แล้วทิ้งระเบิด  เราต้องหา สองอย่างคือ  ก. ระเบิดตกไกลจากจุดที่ทิ้งในแนวราบเท่าใด  และ ข. ระเบิดกระทบพื้นดินด้วยอัตราเร็วเท่าใด  มาเริ่มที่ข้อ ก. กันก่อน  ขั้นแรก เราต้องหาเวลาที่ระเบิดใช้ในการตกถึงพื้น  ใช้สมการการเคลื่อนที่ในแนวดิ่ง  เอส วาย เท่ากับ ยู วาย ที บวก เศษหนึ่งส่วนสอง จี ที กำลังสอง  ความเร็วต้นในแนวดิ่ง ยู วาย เป็นศูนย์  เอส วาย คือความสูง สองพัน เมตร  จี คือ สิบ เมตรต่อวินาทีกำลังสอง  แทนค่า สองพัน เท่ากับ ศูนย์ คูณ ที บวก เศษหนึ่งส่วนสอง คูณ สิบ คูณ ที กำลังสอง  แก้สมการจะได้ ที กำลังสอง เท่ากับ สี่ร้อย  ดังนั้น ที เท่ากับ ยี่สิบ วินาที  เมื่อได้เวลาแล้ว  เราก็หา เอส เอ็กซ์ หรือระยะทางแนวราบได้เลย  ใช้สมการ เอส เอ็กซ์ เท่ากับ วี เอ็กซ์ คูณ ที  วี เอ็กซ์ คือความเร็วในแนวราบ ซึ่งเท่ากับความเร็วเครื่องบิน สองร้อย เมตรต่อวินาที  และ ที คือ ยี่สิบ วินาที  แทนค่า สองร้อย คูณ ยี่สิบ  จะได้ เอส เอ็กซ์ เท่ากับ สี่พัน เมตร  ระเบิดจะตกไกล สี่พัน เมตร จากจุดที่ทิ้งในแนวราบ  ต่อไปข้อ ข. เราจะหาอัตราเร็วของระเบิดขณะกระทบพื้น  เราต้องหาความเร็วในแนวดิ่งสุดท้ายก่อน  ใช้สมการ วี วาย เท่ากับ ยู วาย บวก จี ที  ยู วาย เป็นศูนย์  จี คือ สิบ  ที คือ ยี่สิบ  ดังนั้น วี วาย เท่ากับ ศูนย์ บวก สิบ คูณ ยี่สิบ  เท่ากับ สองร้อย เมตรต่อวินาที  ความเร็วในแนวราบ วี เอ็กซ์ ยังคงเป็น สองร้อย เมตรต่อวินาที เท่าเดิม  อัตราเร็วสุดท้าย วี คือขนาดของเวกเตอร์ความเร็วรวม  หาได้จาก สแควร์รูทของ วี เอ็กซ์ กำลังสอง บวก วี วาย กำลังสอง  แทนค่า สแควร์รูทของ สองร้อย กำลังสอง บวก สองร้อย กำลังสอง  จะได้ สแควร์รูทของ สี่หมื่น บวก สี่หมื่น  เท่ากับ สแควร์รูทของ แปดหมื่น  ซึ่งก็คือ สองร้อย รูทสอง เมตรต่อวินาที นั่นเอง!",
        "example_or_trick": "การแยกคิดการเคลื่อนที่ในแนวราบและแนวดิ่งเป็นหัวใจสำคัญของโจทย์โปรเจกไทล์  จำไว้ว่าในแนวราบความเร็วคงที่  แต่ในแนวดิ่งมีความเร่งโน้มถ่วงเข้ามาเกี่ยวข้องเสมอ  และเวลาคือตัวเชื่อมโยงทั้งสองแนวเข้าด้วยกัน",
        "call_to_action": "ลองจินตนาการภาพการเคลื่อนที่ของระเบิดตามไปด้วยนะ จะช่วยให้เข้าใจฟิสิกส์ได้ดียิ่งขึ้น!"
      },
      "manim_code_lines": [
        "import numpy as np",
        "from manim import *",
