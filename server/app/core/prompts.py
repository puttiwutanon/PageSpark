...
□ 21. estimated_duration_seconds ≥ 30 และ self.wait() รวมทั้งหมดในโค้ด ตรงกับ
...
[10.1] ความยาววิดีโอต้องไม่ต่ำกว่า 30 วินาที และต้องสอดคล้องกับความยาวบทพูดจริง
...
สอดคล้องกับ voiceover_script (≥30 วินาทีเสมอ), ตรวจว่าสีและแอนิเมชันที่ใช้อยู่ในรายการที่อนุญาต
ตามข้อ 5A เท่านั้น
